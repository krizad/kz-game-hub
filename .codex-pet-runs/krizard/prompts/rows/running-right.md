Create one horizontal animation strip for Codex pet `krizard`, state `running-right`.
...
Identity: same pet in every frame: A compact teal-and-violet gecko-dragon game master with warm Thai-inspired gold accents, expressive intelligent eyes, tiny horn nubs, a curled tail, and one small game-controller charm attached like a badge. Friendly, inventive, quietly technical, energetic when hosting games. No readable logos or text.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `3d-toy`: Stylized 3D toy mascot with smooth rounded forms, simple materials, clear silhouette, and no photoreal complexity. User style notes: Polished soft vinyl designer-toy aesthetic, rounded readable silhouette, subtle satin material, bold large features suitable for a 192x208 sprite cell..
