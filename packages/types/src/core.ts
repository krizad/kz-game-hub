...
export const SOCKET_EVENTS = {
  ...
  PRIVATE_STATE_UPDATED: 'private_state_updated',
  ...
  DETECTIVE_CLUB_RESET: 'detective_club_reset',
...
export interface UserState {
  ...
  hasBeenHost?: boolean;
  connected?: boolean;
  /** True when the player joined after the game started: they watch but cannot play. */
  isViewer?: boolean;
  color?: string;
  avatar?: string;
}
