...
export interface SaboteurLogEntry {
    seq: number;
    playerId: string;
    kind: 'PLACE' | 'BREAK' | 'REPAIR' | 'MAP' | 'ROCKFALL' | 'DISCARD' | 'PASS' | 'PICK_GOLD' | 'MINERS_WIN' | 'SABOTEURS_WIN';
    cardId?: string;
    tool?: SaboteurTool;
    targetId?: string;
    x?: number;
