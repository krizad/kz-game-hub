...
export type CardDecision = 'PENDING' | 'STAND' | 'DRAWN' | 'NATURAL' | 'PLAYED' | 'PASSED' | 'CLAIMED' | 'DISCARDED' | 'TOOK';
 ...
 */
export type DealCountMode = 'EQUAL_WITH_LEFTOVERS' | 'DEAL_ALL' | 'DEAL_ALL_UNEVEN' | 'REJECT_IF_NOT_EVEN';
export type StarterPolicy = 'RANDOM' | 'HOST_SELECT' | 'ROTATE' | 'PREVIOUS_WINNER' | 'PREVIOUS_LOSER';
...
export type RoundEndConditionKind = 'NATURAL_HAND' | 'ALL_PLAYERS_RESOLVED' | 'DEALER_RESOLVED' | 'STOCK_EMPTY' | 'FIRST_EMPTY_HAND' | 'LAST_HOLDER_STANDING';
...
export type CardGameLogKind = 'DREW' | 'STOOD' | 'PLAYED' | 'PASSED' | 'CLAIMED' | 'DISCARDED' | 'TOOK';
