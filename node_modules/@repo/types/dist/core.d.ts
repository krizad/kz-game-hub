 ...
 */
export declare const TTT_MODE_FLAGS: readonly ["GOBBLER_MODE", "ULTIMATE_MODE"];
...
export declare const SOCKET_EVENTS: {
    ...
    readonly GET_GAME_SETTINGS: "get_game_settings";
    readonly GAME_SETTINGS_UPDATED: "game_settings_updated";
    readonly SET_GAME_ENABLED: "set_game_enabled";
