...
exports.SABOTEUR_GOAL_POSITIONS = exports.SABOTEUR_START_POS = exports.SABOTEUR_BOARD_BOUNDS = exports.SABOTEUR_TOTAL_ROUNDS = exports.SABOTEUR_HAND_SIZE_TABLE = exports.SABOTEUR_ROLE_TABLE = exports.SABOTEUR_GOLD_DECK = exports.SABOTEUR_DRAW_CARDS = exports.SABOTEUR_GOAL_CARD = exports.SABOTEUR_START_CARD = exports.SaboteurActionKind = exports.SaboteurTool = exports.SaboteurRole = exports.SaboteurPhase = void 0;
exports.saboteurCellKey = saboteurCellKey;
exports.saboteurRotateEdge = saboteurRotateEdge;
exports.saboteurRotatedPaths = saboteurRotatedPaths;
exports.saboteurGetCardDef = saboteurGetCardDef;
exports.saboteurTraceNetwork = saboteurTraceNetwork;
exports.saboteurSimulatePlacement = saboteurSimulatePlacement;
exports.saboteurValidPlacements = saboteurValidPlacements;
var SaboteurPhase;
(function (SaboteurPhase) {
    SaboteurPhase["PLAYING"] = "PLAYING";
    SaboteurPhase["GOLD_PICK"] = "GOLD_PICK";
    SaboteurPhase["ROUND_END"] = "ROUND_END";
    SaboteurPhase["GAME_OVER"] = "GAME_OVER";
})(SaboteurPhase || (exports.SaboteurPhase = SaboteurPhase = {}));
var SaboteurRole;
(function (SaboteurRole) {
    SaboteurRole["MINER"] = "MINER";
    SaboteurRole["SABOTEUR"] = "SABOTEUR";
})(SaboteurRole || (exports.SaboteurRole = SaboteurRole = {}));
var SaboteurTool;
(function (SaboteurTool) {
    SaboteurTool["LANTERN"] = "LANTERN";
    SaboteurTool["CART"] = "CART";
    SaboteurTool["PICKAXE"] = "PICKAXE";
})(SaboteurTool || (exports.SaboteurTool = SaboteurTool = {}));
var SaboteurActionKind;
(function (SaboteurActionKind) {
    SaboteurActionKind["BREAK"] = "BREAK";
    SaboteurActionKind["REPAIR"] = "REPAIR";
    SaboteurActionKind["MAP"] = "MAP";
    SaboteurActionKind["ROCKFALL"] = "ROCKFALL";
})(SaboteurActionKind || (exports.SaboteurActionKind = SaboteurActionKind = {}));
...
exports.SABOTEUR_GOAL_CARD = {
    id: 'goal',
    kind: 'PATH',
    paths: [[0], [1], [2], [3]],
    quantity: 3,
};
exports.SABOTEUR_DRAW_CARDS = [
    ...SABOTEUR_PATH_CARDS,
    ...SABOTEUR_ACTION_CARDS,
];
// Gold nugget card distribution: 28 cards.
exports.SABOTEUR_GOLD_DECK = [
...
exports.SABOTEUR_HAND_SIZE_TABLE = {
    3: 6,
    4: 6,
    5: 6,
    6: 5,
...
exports.SABOTEUR_TOTAL_ROUNDS = 3;
// Board geometry
exports.SABOTEUR_BOARD_BOUNDS = { minX: 0, maxX: 8, minY: 0, maxY: 4 };
exports.SABOTEUR_START_POS = { x: 0, y: 2 };
exports.SABOTEUR_GOAL_POSITIONS = [
    { x: 8, y: 1 },
    { x: 8, y: 2 },
    { x: 8, y: 3 },
...
function saboteurCellKey(x, y) {
    return `${x},${y}`;
}
function saboteurRotateEdge(edge, rotation) {
    return rotation === 180 ? (edge + 2) % 4 : edge;
}
function saboteurRotatedPaths(paths, rotation) {
    return paths.map((group) => group.map((e) => saboteurRotateEdge(e, rotation)));
}
const SABOTEUR_CARD_DEF_INDEX = (() => {
    const defs = [...exports.SABOTEUR_DRAW_CARDS, exports.SABOTEUR_START_CARD, exports.SABOTEUR_GOAL_CARD];
    return new Map(defs.map((d) => [d.id, d]));
})();
function saboteurGetCardDef(cardId) {
...
function saboteurTraceNetwork(board) {
    ...
    const startPos = exports.SABOTEUR_START_POS;
...
function saboteurSimulatePlacement(board, x, y, cardId, rotation) {
    const { minX, maxX, minY, maxY } = exports.SABOTEUR_BOARD_BOUNDS;
    ...
    for (let d = 0; d < 4; d++) {
        ...
        const nOpen = new Set(nDef?.paths ? saboteurRotatedPaths(nDef.paths, nCell.rotation).flat() : []);
...
function saboteurValidPlacements(board, cardId) {
    const results = [];
    const seen = new Set();
    const { minX, maxX, minY, maxY } = exports.SABOTEUR_BOARD_BOUNDS;
