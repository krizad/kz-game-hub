...
export function WhoKnowRules() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-300">
      <div>
        <h3 className="text-indigo-400 font-black uppercase tracking-wider text-sm mb-3">
          {t('rules.whoKnow.setupTitle')}
        </h3>
        <p className="leading-relaxed">
          {t('rules.whoKnow.setupDesc1')}
          <strong className="text-amber-500">{t('rules.whoKnow.setupDescGameHost')}</strong>
          {t('rules.whoKnow.setupDesc2')}
          <strong className="text-rose-400">{t('rules.whoKnow.setupDescInsider')}</strong>
          {t('rules.whoKnow.setupDesc3')}
          <strong className="text-slate-800">{t('rules.whoKnow.setupDescCommoners')}</strong>.
        </p>
      </div>
      ...
      <div>
        ...
        <ol className="space-y-4">
          <li className="flex gap-4">
            <span className="flex-shrink-0 w-8 h-8 rounded-full bg-amber-100 text-slate-800 font-bold flex items-center justify-center">
              1
            </span>
            <div>
        ...
        <ul className="space-y-3">
          <li className="flex items-start gap-3">
            ...
            <span>
              ...
              <strong>{t('rules.whoKnow.winCond1B')}</strong>
          ...
          <li className="flex items-start gap-3">
            ...
            <span>
              ...
              <strong>{t('rules.whoKnow.winCond2B')}</strong>
          ...
          <li className="flex items-start gap-3">
            ...
            <span>
              ...
              <span className="text-green-400 font-bold">{t('rules.whoKnow.winCond3B')}</span>
            </span>
          </li>
        </ul>
      </div>
