...
export function TicTacToeRules() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-300">
      <div>
        <h3 className="text-zinc-400 font-black uppercase tracking-wider text-sm mb-3">
          {t('rules.ticTacToe.title')}
        </h3>
        <p className="leading-relaxed">{t('rules.ticTacToe.desc')}</p>
      </div>
      <div>
        <h3 className="text-zinc-400 font-black uppercase tracking-wider text-sm mb-3">
        ...
        <ul className="space-y-3">
          <li className="flex items-start gap-3">
            ...
            <span>
              ...
              <strong>{t('rules.ticTacToe.winDesc1B')}</strong>
          ...
          <li className="flex items-start gap-3">
            ...
            <span>
              ...
              <strong>{t('rules.ticTacToe.winDesc2B')}</strong>.
            </span>
          </li>
        </ul>
      </div>
