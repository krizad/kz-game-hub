  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-300">
      <div>
        ...
        <p className="leading-relaxed">{t('rules.soundsFishy.desc')}</p>
      </div>
      ...
      <div>
        ...
        <ul className="space-y-4 border-l-2 border-amber-200 pl-4 py-1">
          <li className="text-slate-700">
            ...
            {t('rules.soundsFishy.scoreRedHerring')}
          </li>
          <li className="text-slate-700">
            <span className="text-amber-400 font-bold">💰</span> {t('rules.soundsFishy.scoreBank')}
          </li>
          <li className="text-slate-700">
            <span className="text-blue-400 font-bold">💀</span>{' '}
            {t('rules.soundsFishy.scoreBlueFish')}
          </li>
        </ul>
      </div>
    </div>
