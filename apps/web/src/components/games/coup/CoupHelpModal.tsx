          ...
          >
            ...
            <div className="grid gap-2 text-xs">
              <div className="border-2 border-black p-2 bg-[#E0E7FF]">
                ...
                <div className="opacity-80">{t('gameCoup.roleDukeDesc')}</div>
              </div>
              <div className="border-2 border-black p-2 bg-[#FECACA]">
                <div className="font-black">{t('gameCoup.roleAssassin')}</div>
                <div className="opacity-80">{t('gameCoup.roleAssassinDesc')}</div>
              </div>
              <div className="border-2 border-black p-2 bg-[#A7F3D0]">
                <div className="font-black">{t('gameCoup.roleCaptain')}</div>
                <div className="opacity-80">{t('gameCoup.roleCaptainDesc')}</div>
              </div>
              <div className="border-2 border-black p-2 bg-[#FDE68A]">
                <div className="font-black">{t('gameCoup.roleAmbassador')}</div>
                <div className="opacity-80">{t('gameCoup.roleAmbassadorDesc')}</div>
              </div>
              <div className="border-2 border-black p-2 bg-[#DDD6FE]">
                <div className="font-black">{t('gameCoup.roleContessa')}</div>
                <div className="opacity-80">{t('gameCoup.roleContessaDesc')}</div>
              </div>
            </div>
