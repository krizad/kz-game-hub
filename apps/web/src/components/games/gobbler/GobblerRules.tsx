      ...
      <div>
        ...
        <ul className="space-y-4">
          <li className="flex gap-3">
            <span className="text-slate-800 mt-0.5 flex-shrink-0 text-xl leading-none">📏</span>
            <div>
              <strong className="text-slate-800 block mb-1">{t('rules.gobbler.pieceSizesTitle')}</strong>
          ...
          <li className="flex gap-3">
            ...
            <div>
              <strong className="text-slate-800 block mb-1">{t('rules.gobbler.gobblingTitle')}</strong>
          ...
          <li className="flex gap-3">
            ...
            <div>
              <strong className="text-slate-800 block mb-1">{t('rules.gobbler.movingTitle')}</strong>
          ...
          <li className="flex gap-3">
            ...
            <div>
              <strong className="text-slate-800 block mb-1">{t('rules.gobbler.winningTitle')}</strong>
